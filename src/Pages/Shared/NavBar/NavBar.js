      ...
      <div className="relative flex items-center justify-between">
        ...
        <div className="lg:hidden">
          <button
            ...
            title="Open Menu"
            className="p-2 -mr-1 transition duration-1000 du rounded focus:outline-none focus:shadow-outline hover:bg-deep-purple-50 focus:bg-deep-purple-50"
          ...
          {isMenuOpen && (
            <div className="absolute top-0 left-0 w-full translate duration-700">
